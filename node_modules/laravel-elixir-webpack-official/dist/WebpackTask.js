...
var WebpackTask = function (_Elixir$Task) {
    ...
    _createClass(WebpackTask, [{
        ...
        // Source: https://github.com/laravel/elixir/issues/598#issuecomment-238345649
        // Author: lukepolo [https://github.com/lukepolo]
   {
        key: 'registerWatchers',
        value: function registerWatchers() {
            this.watchers.push(this.paths.src.baseDir + '/**/*');
        }
    }
    ]);
